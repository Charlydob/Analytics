export function renderHome(){
  ...
  el.innerHTML = `
    ...
    <section class="card small hint">Consejo: añade tus primeros vídeos desde la pestaña “Vídeos”.</section>
  `;
  // KPIs mínimos (placeholder)
  const db = firebase.database();
  db.ref('videos').once('value').then(s=>{
    const v = s.val() || {};
